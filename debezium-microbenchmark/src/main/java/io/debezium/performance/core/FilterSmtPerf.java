...
public class FilterSmtPerf {
    ...
    public static class TransformState {
        ...
        public void doSetup() {
            ...
            groovyFilter.configure(Collect.hashMapOf("language", "groovy", "condition", "value.op == 'd'"));

            jsFilter = new Filter<>();
            jsFilter.configure(Collect.hashMapOf("language", "graal.js", "condition", "value.get('op') == 'd'"));
        }
    }
