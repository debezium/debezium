...
public class JdbcSchemaHistoryIT extends AbstractConnectorTest {
    ...
    @Test
    public void shouldStreamChanges() throws InterruptedException {
    ...
    @Test
    public void shouldStreamChangesAfterRestart() throws InterruptedException, SQLException {
        Configuration config = config().build();
        ...
        assertThat(((Struct) record.key()).getInt64("id")).isEqualTo(5);
        stopConnector();
    }
}
