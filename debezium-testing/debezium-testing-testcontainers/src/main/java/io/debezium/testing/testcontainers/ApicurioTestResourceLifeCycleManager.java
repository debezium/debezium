...
public class ApicurioTestResourceLifeCycleManager implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        ...
        params.put("converter.apicurio.registry.url", getApicurioUrl());
        params.put("converter.apicurio.registry.global-id", "io.apicurio.registry.utils.serde.strategy.GetOrCreateIdStrategy");
