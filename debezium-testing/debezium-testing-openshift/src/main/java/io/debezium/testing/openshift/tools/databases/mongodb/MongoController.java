 ...
 */
public class MongoController extends AbstractOcpDatabaseController<MongoDatabaseClient> {
    ...
    public MongoController(Deployment deployment, List<Service> services, OpenShiftClient ocp) {
