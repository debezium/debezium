...
import static io.debezium.testing.openshift.resources.ConfigProperties.DATABASE_SQLSERVER_DBZ_DBNAME;
import static io.debezium.testing.openshift.resources.ConfigProperties.DATABASE_SQLSERVER_DBZ_PASSWORD;
import static io.debezium.testing.openshift.resources.ConfigProperties.DATABASE_SQLSERVER_DBZ_USERNAME;
...
import io.debezium.testing.openshift.tools.databases.SqlServerController;
import io.debezium.testing.openshift.tools.databases.SqlServerDeployer;
...
//
     ...
     public void shouldStreamChanges() throws SQLException {
         String sql = "INSERT INTO customers (first_name, last_name, email) VALUES ('Tom', 'Tester', 'tom@test.com')";
         dbController.executeStatement(DATABASE_SQLSERVER_DBZ_DBNAME, DATABASE_SQLSERVER_DBZ_USERNAME, DATABASE_SQLSERVER_DBZ_PASSWORD, sql);
     ...
     public void shouldBeDown() throws SQLException, IOException {
         kafkaConnectController.undeployConnector(connectorName);
         String sql = "INSERT INTO customers (first_name, last_name, email) VALUES ('Jerry', 'Tester', 'jerry@test.com')";
         dbController.executeStatement(DATABASE_SQLSERVER_DBZ_DBNAME, DATABASE_SQLSERVER_DBZ_USERNAME, DATABASE_SQLSERVER_DBZ_PASSWORD, sql);
         awaitAssert(() ->assertRecordsCount(connectorName + ".dbo.customers", 5));
     }
     ...
     public void shouldBeDownAfterCrash() throws SQLException {
         ...
         String sql = "INSERT INTO customers (first_name, last_name, email) VALUES ('Nibbles', 'Tester', 'nibbles@test.com')";
         dbController.executeStatement(DATABASE_SQLSERVER_DBZ_DBNAME, DATABASE_SQLSERVER_DBZ_USERNAME, DATABASE_SQLSERVER_DBZ_PASSWORD, sql);
         awaitAssert(() -> assertRecordsCount(connectorName + ".dbo.customers", 6));
     }
