...
import io.debezium.testing.system.fixtures.databases.docker.DockerInformix;
...
@Fixture(DockerInformix.class)
@Fixture(InformixConnector.class)
@ExtendWith(FixtureExtension.class)
public class DockerRhelInformixConnectorIT extends InformixTests {

    public DockerRhelInformixConnectorIT(KafkaController kafkaController,
