...
public class OpenLineageEventEmitter {
    ...
    public OpenLineageEventEmitter(ConnectorContext connectorContext, DebeziumOpenLineageConfiguration config) {
    ...
    public OpenLineageEventEmitter(OpenLineageClient client, ConnectorContext connectorContext) {
