...
public class JsonSchemaCreatorService {
    ...
    public Schema buildConnectorSchema() {
        ...
        schema.setTitle(connectorName);
        schema.setType(Schema.SchemaType.OBJECT);
        schema.addExtension("version", connectorMetadata.getConnector().version());
        schema.addExtension("className", connectorMetadata.getConnector().getClass().getName());
        schema.addExtension("realname", connectorMetadata.getConnectorDescriptor().name);
