...
public class SqlServerConnection extends JdbcConnection {
    ...
    public SqlServerConnection(Configuration config, Clock clock, SourceTimestampMode sourceTimestampMode, SqlServerValueConverters valueConverters,
        ...
        this(config, clock, sourceTimestampMode, valueConverters, classLoaderSupplier, Collections.<Envelope.Operation> emptySet());
    ...
    public SqlServerConnection(Configuration config, Clock clock, SourceTimestampMode sourceTimestampMode, SqlServerValueConverters valueConverters,
        ...
        if (!skippedOperations.isEmpty()) {
            ...
            get_all_changes_for_table = "SELECT * FROM cdc.[fn_cdc_get_all_changes_#](?, ?, N'all update old') order by [__$start_lsn] ASC, [__$seqval] ASC, [__$operation] ASC";
        }
