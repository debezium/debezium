...
* Upgraded to Kafka 0.10.0.0, which means that the Debezium connectors can only be used with Kafka Connect 0.10.0.0. [DBZ-62](https://issues.jboss.org/projects/DBZ/issues/DBZ-62), [DBZ-80](https://issues.jboss.org/projects/DBZ/issues/DBZ-80)
