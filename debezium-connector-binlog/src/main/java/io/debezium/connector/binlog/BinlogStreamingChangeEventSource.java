...
public abstract class BinlogStreamingChangeEventSource<P extends BinlogPartition, O extends BinlogOffsetContext>
    ...
    private boolean isDmlStatement(String upperCasedStatementBegin) {
        return upperCasedStatementBegin.startsWith("INSERT ") ||
                upperCasedStatementBegin.startsWith("UPDATE ") ||
                upperCasedStatementBegin.startsWith("DELETE ") ||
                upperCasedStatementBegin.startsWith("REPLACE ");
    }
