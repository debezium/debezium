...
public abstract class BinlogMetadataIT<C extends SourceConnector> extends AbstractBinlogConnectorIT<C> {
    ...
    public void shouldLoadMetadataViaJdbc() throws SQLException {
        ...
        try (BinlogTestConnection conn = getTestDatabaseConnection(DATABASE.getDatabaseName())) {
            ...
            assertThat(product.columnWithName("createdByDate").isGenerated()).isEqualTo(conn.isCurrentDateTimeDefaultGenerated());
            ...
            assertThat(product.columnWithName("modifiedDate").isGenerated()).isEqualTo(conn.isCurrentDateTimeDefaultGenerated());
            ...
            assertThat(purchased.columnWithName("purchaseDate").isGenerated()).isEqualTo(conn.isCurrentDateTimeDefaultGenerated());
