 ...
 * @author Harvey Yue
 */
public abstract class BinlogFloatIT<C extends SourceConnector> extends AbstractBinlogConnectorIT<C> {

    private static final String TABLE_NAME = "DBZ3865";
    private static final Path SCHEMA_HISTORY_PATH = Files.createTestingPath("file-schema-history-float.txt")
            .toAbsolutePath();
    private final UniqueDatabase DATABASE = TestHelper.getUniqueDatabase("floatit", "float_test")
    ...
    public void shouldHandleFloatAsFloatAndDouble() throws SQLException, InterruptedException {
        ...
        config = DATABASE.defaultConfig()
                ...
                .with(BinlogConnectorConfig.TABLE_INCLUDE_LIST, includeTables)
                .build();
