...
public interface ReplicationConnection extends AutoCloseable {
     ...
     */
    ReplicationStream startStreaming(WalPositionLocator walPosition, boolean initialize) throws SQLException, InterruptedException;
     ...
     */
    ReplicationStream startStreaming(Lsn offset, WalPositionLocator walPosition, boolean initialize) throws SQLException, InterruptedException;
