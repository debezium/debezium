...
public class PostgresConnectorTask extends BaseSourceTask {
    ...
    public ChangeEventSourceCoordinator start(Configuration config) {
        ...
        final PostgresValueConverter valueConverter = new PostgresValueConverter(
                databaseCharset,
        ...
        jdbcConnection = new PostgresConnection(connectorConfig.jdbcConfig(), typeRegistry, valueConverter);
        try {
        ...
        schema = new PostgresSchema(connectorConfig, typeRegistry, topicSelector, valueConverter);
