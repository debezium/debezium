...
public class SqlServerDatasourceConfiguration implements QuarkusDatasourceConfiguration {
    ...
    public SqlServerDatasourceConfiguration(String host, String username, String password, String database, String port, boolean isDefault, String name) {
        this.host = host;
