...
@Recorder
public class AgroalDatasourceRecorder {
    private static final Logger LOGGER = LoggerFactory.getLogger(AgroalDatasourceRecorder.class);
    ...
    public Supplier<AgroalDatasourceConfiguration> convert(String name, boolean defaultConfiguration, String dbKind) {
    ...
    private Supplier<AgroalDatasourceConfiguration> createConfiguration(String name,
                                                                        String jdbcUrl,
                                                                        String username,
                                                                        String password,
                                                                        boolean isDefault,
        ...
        return () -> new DatasourceParser(jdbcUrl)
                .asString()
                .map(datasource -> new AgroalDatasourceConfiguration(
                        datasource.host(),
                        username,
                        password,
                        datasource.database(),
