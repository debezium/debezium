...
final class RedpandaKafkaContainer extends GenericContainer<RedpandaKafkaContainer> {
    ...
    private String getKafkaAddresses() {
        ...
        // TODO hack
        addresses.add("HOST_DOCKER_INTERNAL://0.0.0.0:19092");
        // TODO \hack
    ...
    private String getKafkaAdvertisedAddresses() {
        ...
        // TODO hack
        addresses.add(String.format("HOST_DOCKER_INTERNAL://%s:%d", HOST_DOCKER_INTERNAL, getMappedPort(19092)));
        // TODO \hack
        return String.join(",", addresses);
    }
