...
public class ExtractNewDocumentStateTest {
    ...
    public void shouldPassHeartbeatMessages() {
        ...
        Schema keySchema = new MongoDbSchemaBuilderFactory().builder("io.debezium.connector.common.ServerNameKey")
    ...
    public void shouldSkipMessagesWithoutDebeziumCdcEnvelopeDueToMissingSchemaName() {
        ...
        Schema keySchema = new MongoDbSchemaBuilderFactory().builder("op.with.heartbeat.Key")
