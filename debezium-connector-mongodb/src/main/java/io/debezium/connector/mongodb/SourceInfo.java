...
public final class SourceInfo {
    ...
    public static final String TIMESTAMP = DpRecordConstants.SOURCE_ENTITY_RECORD_TIMESTAMP_KEY;
    ...
    private final Schema SOURCE_SCHEMA = SchemaBuilder.struct()
        ...
        .field(DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_SIZE_KEY, Schema.OPTIONAL_INT32_SCHEMA)
        .field(DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_LASTRECORD_KEY, Schema.OPTIONAL_BOOLEAN_SCHEMA)
    ...
    public Map<String, ?> lastOffset(String replicaSetName) {
        ...
        offset.put(DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_RECORD_INDEX_KEY, existing.getIndex());
        offset.put(DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_LASTRECORD_KEY, existing.isLastRecord());
    ...
    private Struct offsetStructFor(String replicaSetName, String namespace, Position position) {
        ...
        result.put(DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_RECORD_INDEX_KEY, position.getIndex());
        result.put(DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_LASTRECORD_KEY, position.isLastRecord());
        return result;
    }
    ...
    public boolean setOffsetFor(String replicaSetName, Map<String, ?> sourceOffset) {
        ...
        long index = longOffsetValue(sourceOffset, DpRecordConstants.SOURCE_ENTITY_SNAPSHOT_RECORD_INDEX_KEY);
