 ...
 * Note that this handler is specifically designed for Debezium's CDC event format and does not
 * support events generated by the official MongoDB Kafka Connector.
 */
