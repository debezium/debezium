...
import io.debezium.connector.mongodb.transforms.MongoToRelationalMapper;
...
public class MongoDbMetadataProvider implements ComponentMetadataProvider {
    ...
    public List<ComponentMetadata> getConnectorMetadata() {
        return List.of(
                componentMetadataFactory.createComponentMetadata(new MongoDbConnector(), "Debezium MongoDB Connector",
                        "Captures document changes from a MongoDB database in near real-time.", Module.version()),
                ...
                componentMetadataFactory.createComponentMetadata(new MongoToRelationalMapper<>(), Module.version()),
