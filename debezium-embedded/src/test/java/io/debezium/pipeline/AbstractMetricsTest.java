...
public abstract class AbstractMetricsTest<T extends SourceConnector> extends AbstractConnectorTest {
    ...
    private void assertStreamingMetrics(boolean checkAdvancedMetrics) throws Exception {
        ...
        waitForAvailableRecords(300, TimeUnit.SECONDS);
        ...
        assertThat(mBeanServer.getAttribute(getMultiplePartitionStreamingMetricsObjectName(), "TotalNumberOfEventsSeen")).isEqualTo(expectedEvents());
    ...
    private void assertStreamingWithCustomMetrics(Map<String, String> customMetricTags) throws Exception {
        ...
        assertThat(mBeanServer.getAttribute(getMultiplePartitionStreamingMetricsObjectNameCustomTags(customMetricTags), "TotalNumberOfEventsSeen"))
