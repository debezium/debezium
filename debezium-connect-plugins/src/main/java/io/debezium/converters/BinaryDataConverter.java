 ...
 */
public class BinaryDataConverter implements Converter, HeaderConverter, Versioned, ConfigDescriptor {
    private static final Logger LOGGER = LoggerFactory.getLogger(BinaryDataConverter.class);
    private static final ConfigDef CONFIG_DEF;

    protected static final Field DELEGATE_CONVERTER_TYPE_FIELD = Field.create("delegate.converter.type")
            .withDisplayName("Delegate converter type")
            .withType(ConfigDef.Type.STRING)
            .withImportance(ConfigDef.Importance.LOW)
            .withDescription("Specifies the delegate converter class");

    protected static final String DELEGATE_CONVERTER_TYPE = DELEGATE_CONVERTER_TYPE_FIELD.name();
    ...
    public Field.Set getConfigFields() {
        return Field.setOf(DELEGATE_CONVERTER_TYPE_FIELD);
    }
