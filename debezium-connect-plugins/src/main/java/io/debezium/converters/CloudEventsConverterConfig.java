...
public class CloudEventsConverterConfig extends ConverterConfig {
    ...
    public static final Field CLOUDEVENTS_SERIALIZER_TYPE = Field.create("serializer.type")
            .withDisplayName("CloudEvents serializer type")
            .withType(ConfigDef.Type.STRING)
            .withImportance(ConfigDef.Importance.HIGH)
            .withDefault("json")
            .withDescription("Specify a serializer to serialize CloudEvents values");

    public static final Field CLOUDEVENTS_DATA_SERIALIZER_TYPE = Field.create("data.serializer.type")
            .withDisplayName("CloudEvents data serializer type")
            .withType(ConfigDef.Type.STRING)
            .withImportance(ConfigDef.Importance.HIGH)
            .withDefault("json")
            .withDescription("Specify a serializer to serialize the data field of CloudEvents values");

    public static final Field CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE = Field.create("opentelemetry.tracing.attributes.enable")
            .withDisplayName("Enable OpenTelemetry tracing attributes")
            .withType(ConfigDef.Type.BOOLEAN)
            .withImportance(ConfigDef.Importance.HIGH)
            .withDefault(false)
            .withDescription("Specify whether to include OpenTelemetry tracing attributes to a cloud event");

    public static final Field CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE = Field.create("extension.attributes.enable")
            .withDisplayName("Enable extension attributes")
            .withType(ConfigDef.Type.BOOLEAN)
            .withImportance(ConfigDef.Importance.HIGH)
            .withDefault(true)
            .withDescription("Specify whether to include extension attributes to a cloud event");

    public static final Field CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE = Field.create("schema.name.adjustment.mode")
            .withDisplayName("Schema name adjustment mode")
            .withType(ConfigDef.Type.STRING)
    ...
    public static final Field CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME = Field.create("schema.cloudevents.name")
            .withDisplayName("CloudEvents schema name")
            .withType(ConfigDef.Type.STRING)
            .withImportance(ConfigDef.Importance.LOW)
            .withDescription("Specify CloudEvents schema name under which the schema is registered in a Schema Registry");

    public static final Field CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE = Field.create("schema.data.name.source.header.enable")
            .withDisplayName("Enable schema data name from header")
            .withType(ConfigDef.Type.BOOLEAN)
            .withImportance(ConfigDef.Importance.LOW)
            .withDefault(false)
            .withDescription("Specify whether CloudEvents.data schema name can be retrieved from the header");

    public static final Field CLOUDEVENTS_METADATA_SOURCE = Field.create("metadata.source")
            .withDisplayName("Metadata source")
            .withType(ConfigDef.Type.LIST)
            .withImportance(ConfigDef.Importance.HIGH)
            .withDefault("value,id:generate,type:generate,traceparent:header,dataSchemaName:generate")
            .withDescription("Specify from where to retrieve metadata");

    // Backward compatibility constants
    public static final String CLOUDEVENTS_SERIALIZER_TYPE_CONFIG = CLOUDEVENTS_SERIALIZER_TYPE.name();
    public static final String CLOUDEVENTS_SERIALIZER_TYPE_DEFAULT = (String) CLOUDEVENTS_SERIALIZER_TYPE.defaultValue();

    public static final String CLOUDEVENTS_DATA_SERIALIZER_TYPE_CONFIG = CLOUDEVENTS_DATA_SERIALIZER_TYPE.name();
    public static final String CLOUDEVENTS_DATA_SERIALIZER_TYPE_DEFAULT = (String) CLOUDEVENTS_DATA_SERIALIZER_TYPE.defaultValue();

    public static final String CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE_CONFIG = CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE.name();
    public static final boolean CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE_DEFAULT = (Boolean) CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE
            .defaultValue();

    public static final String CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE_CONFIG = CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE.name();
    public static final boolean CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE_DEFAULT = (Boolean) CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE.defaultValue();

    public static final String CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE_CONFIG = CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE.name();
    public static final String CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE_DEFAULT = (String) CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE.defaultValue();

    public static final String CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME_CONFIG = CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME.name();
    public static final String CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME_DEFAULT = null;

    public static final String CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE_CONFIG = CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE.name();
    public static final boolean CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE_DEFAULT = (Boolean) CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE.defaultValue();

    public static final String CLOUDEVENTS_METADATA_SOURCE_CONFIG = CLOUDEVENTS_METADATA_SOURCE.name();
    public static final String CLOUDEVENTS_METADATA_SOURCE_DEFAULT = (String) CLOUDEVENTS_METADATA_SOURCE.defaultValue();
    ...
    static {
        ...
        CONFIG.define(CLOUDEVENTS_SERIALIZER_TYPE_CONFIG, ConfigDef.Type.STRING, CLOUDEVENTS_SERIALIZER_TYPE_DEFAULT, ConfigDef.Importance.HIGH,
                CLOUDEVENTS_SERIALIZER_TYPE.description());
        CONFIG.define(CLOUDEVENTS_DATA_SERIALIZER_TYPE_CONFIG, ConfigDef.Type.STRING, CLOUDEVENTS_DATA_SERIALIZER_TYPE_DEFAULT, ConfigDef.Importance.HIGH,
                CLOUDEVENTS_DATA_SERIALIZER_TYPE.description());
        CONFIG.define(CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE_CONFIG, ConfigDef.Type.BOOLEAN, CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE_DEFAULT,
                ...
                CLOUDEVENTS_OPENTELEMETRY_TRACING_ATTRIBUTES_ENABLE.description());
        CONFIG.define(CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE_CONFIG, ConfigDef.Type.BOOLEAN, CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE_DEFAULT, ConfigDef.Importance.HIGH,
                CLOUDEVENTS_EXTENSION_ATTRIBUTES_ENABLE.description());
        CONFIG.define(CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE_CONFIG, ConfigDef.Type.STRING, CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE_DEFAULT, ConfigDef.Importance.LOW,
                CLOUDEVENTS_SCHEMA_NAME_ADJUSTMENT_MODE.description());
        CONFIG.define(CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME_CONFIG, ConfigDef.Type.STRING, CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME_DEFAULT, ConfigDef.Importance.LOW,
                CLOUDEVENTS_SCHEMA_CLOUDEVENTS_NAME.description());
        CONFIG.define(CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE_CONFIG, ConfigDef.Type.BOOLEAN, CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE_DEFAULT,
                ...
                CLOUDEVENTS_SCHEMA_DATA_NAME_SOURCE_HEADERS_ENABLE.description());
        CONFIG.define(CLOUDEVENTS_METADATA_SOURCE_CONFIG, ConfigDef.Type.LIST, CLOUDEVENTS_METADATA_SOURCE_DEFAULT, ConfigDef.Importance.HIGH,
                CLOUDEVENTS_METADATA_SOURCE.description());
    }
