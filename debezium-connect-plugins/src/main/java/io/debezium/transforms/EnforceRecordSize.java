...
public class EnforceRecordSize<R extends ConnectRecord<R>> implements Transformation<R>, Versioned {
    ...
    private static final ConfigDef CONFIG_DEF = new ConfigDef()
            ...
            .define(MIN_FIELD_SIZE_CONF,
                    ...
                    25000,
                    ConfigDef.Importance.MEDIUM,
                    "Fields with a size at or below this value (in bytes) will not be truncated. " +
    ...
    public R apply(R record) {
        ...
        truncateStructFields(value, "before", excess);
        truncateStructFields(value, "after", excess);
    ...
    private void truncateStructFields(Struct envelope, String fieldName, long excess) {
        ...
        long totalTruncatableBytes = truncatableFields.stream()
                .mapToLong(field -> field.sizeBytes)
                .sum();
