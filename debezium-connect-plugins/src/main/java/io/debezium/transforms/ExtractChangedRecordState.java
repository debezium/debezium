 ...
 * @author Harvey Yue
 */
public class ExtractChangedRecordState<R extends ConnectRecord<R>> implements Transformation<R>, Versioned, ConfigDescriptor {
    ...
    public Field.Set getConfigFields() {
        return Field.setOf(HEADER_CHANGED_NAME, HEADER_UNCHANGED_NAME);
    }
}
