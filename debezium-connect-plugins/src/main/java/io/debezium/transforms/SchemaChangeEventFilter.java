 ...
 * @param <R>
 */
public class SchemaChangeEventFilter<R extends ConnectRecord<R>> implements Transformation<R>, Versioned, ConfigDescriptor {
    ...
    public Field.Set getConfigFields() {
        return Field.setOf(SCHEMA_CHANGE_EVENT_EXCLUDE_LIST);
    }
}
