 ...
 *
 */
public class GeometryFormatTransformer<R extends ConnectRecord<R>> implements Transformation<R>, Versioned, io.debezium.metadata.ConfigDescriptor {
    ...
    public io.debezium.config.Field.Set getConfigFields() {
        return io.debezium.config.Field.setOf(GEOMETRY_FORMAT);
    }
