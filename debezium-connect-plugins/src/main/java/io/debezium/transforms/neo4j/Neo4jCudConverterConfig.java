...
public class Neo4jCudConverterConfig {
    ...
    private void validate() {
        ...
        if (nodeMode == NodeMode.RELATIONSHIP && relationships.isEmpty()) {
            throw new ConfigException("relationship.*", null, "At least one relationship mapping is required when node.mode=relationship");
        }
