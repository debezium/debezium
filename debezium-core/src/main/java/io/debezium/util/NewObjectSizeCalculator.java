 ...
 */
public class NewObjectSizeCalculator {
    ...
    public static long getObjectSize(Object obj) throws UnsupportedOperationException {
        return obj == null ? 0 : new NewObjectSizeCalculator(CurrentLayout.SPEC).calculateObjectSize(obj);
    }
    ...
    private final ClassValue<ClassSizeInfo> classSizeInfos = new ClassValue<>() {

        @Override
        protected ClassSizeInfo computeValue(Class<?> type) {
            return new ClassSizeInfo(type);
        }
     ...
     */
    public NewObjectSizeCalculator(MemoryLayoutSpecification memoryLayoutSpecification) {
    ...
    private static class ArrayElementsVisitor {
        ...
        public void visit(NewObjectSizeCalculator calc) {
    ...
    private class ClassSizeInfo {
        ...
        void visit(Object obj, NewObjectSizeCalculator calc) {
            calc.increaseSize(objectSize);
            enqueueReferencedObjects(obj, calc);
        }

        public void enqueueReferencedObjects(Object obj, NewObjectSizeCalculator calc) {
