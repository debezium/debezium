...
public interface DatabaseHistory {
     ...
     *
     * @param offsets the map of the information about the source database to is respective point in history at which
     *            the {@link Tables database schema} should be recovered; none of the keys, values and the map itself may be null
