...
public interface JdbcConfiguration extends Configuration {
     ...
     */
    Field HOSTNAME = Field.create(ConfigurationDefinition.DATABASE_HOSTNAME_PROPERTY_NAME, "IP address of the database");

    /**
     * A field for the port of the database server. There is no default value.
     */
    Field PORT = Field.create(ConfigurationDefinition.DATABASE_PORT_PROPERTY_NAME, "Port of the database");
