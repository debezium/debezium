 ...
 *
 */
public class ByDatabaseTopicNamingStrategyTest {

    private final ByDatabaseTopicNamingStrategy strategy = new ByDatabaseTopicNamingStrategy();
    ...
    @Test
    public void shouldUseOnlyDatabaseNameInTopicNames() {
        assertThat(strategy.getTopic("abc", "db", "t1")).isEqualTo("abc.db");
        assertThat(strategy.getTopic("abc.b.c", "db", "t1")).isEqualTo("abc.b.c.db");
    }
