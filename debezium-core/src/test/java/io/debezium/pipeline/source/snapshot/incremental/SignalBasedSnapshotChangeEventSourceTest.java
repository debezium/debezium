...
public class SignalBasedSnapshotChangeEventSourceTest {
    ...
    public void testBuildQueryOnePkColumn() {
        ...
        Assertions.assertThat(source.buildChunkQuery(table)).isEqualTo("SELECT * FROM \"s1\".\"table1\" WHERE 1=1 ORDER BY pk1 LIMIT 1024");
    ...
    public void testBuildQueryThreePkColumns() {
        ...
        Assertions.assertThat(source.buildChunkQuery(table)).isEqualTo("SELECT * FROM \"s1\".\"table1\" WHERE 1=1 ORDER BY pk1, pk2, pk3 LIMIT 1024");
        context.nextChunkPosition(new Object[]{ 1, 5 });
        context.maximumKey(new Object[]{ 10, 50 });
        Assertions.assertThat(source.buildChunkQuery(table)).isEqualTo(
    ...
    public void testMaxQuery() {
        ...
        Assertions.assertThat(source.buildMaxPrimaryKeyQuery(table)).isEqualTo("SELECT * FROM \"s1\".\"table1\" WHERE 1=1 ORDER BY pk1 DESC, pk2 DESC LIMIT 1");
    }
}
