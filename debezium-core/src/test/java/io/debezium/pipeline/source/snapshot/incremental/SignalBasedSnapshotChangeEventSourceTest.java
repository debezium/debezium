...
public class SignalBasedSnapshotChangeEventSourceTest {
    ...
    public void testBuildQueryOnePkColumn() {
        ...
        Assertions.assertThat(source.buildChunkQuery(table)).isEqualTo("SELECT \"pk1\", \"val1\", \"val2\" FROM \"s1\".\"table1\" ORDER BY pk1 LIMIT 1024");
    ...
    public void testMaxQuery() {
        ...
        Assertions.assertThat(source.buildMaxPrimaryKeyQuery(table)).isEqualTo("SELECT \"pk1\", \"pk2\" FROM \"s1\".\"table1\" ORDER BY pk1 DESC, pk2 DESC LIMIT 1");
    }
}
