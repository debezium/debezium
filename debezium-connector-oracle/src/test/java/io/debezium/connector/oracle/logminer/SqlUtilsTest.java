...
public class SqlUtilsTest {
    ...
    @Test
    public void testStartLogMinerSql() {
        String result = SqlUtils.startLogMinerStatement(Scn.valueOf(10L), Scn.valueOf(20L), OracleConnectorConfig.LogMiningStrategy.ONLINE_CATALOG, true);
    ...
    @Test
    public void testRemoveLogFileFromSessionSql() {
        String result = SqlUtils.deleteLogFileStatement("file_name");
        String expected = "BEGIN SYS.DBMS_LOGMNR.REMOVE_LOGFILE(LOGFILENAME => 'file_name');END;";
        assertThat(result).isEqualTo(expected);
    }
}
