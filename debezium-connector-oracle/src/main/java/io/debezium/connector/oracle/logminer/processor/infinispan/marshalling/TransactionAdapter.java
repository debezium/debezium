...
public class TransactionAdapter {
     ...
     */
    @ProtoFactory
    public Transaction factory(String transactionId, String scn, String changeTime, List<LogMinerEvent> events, int numberOfEvents) {
        return new Transaction(transactionId, Scn.valueOf(scn), Instant.parse(changeTime), events, numberOfEvents);
    }
