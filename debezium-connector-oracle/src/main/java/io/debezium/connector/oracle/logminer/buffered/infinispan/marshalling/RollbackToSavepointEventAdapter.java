 ...
 */
@ProtoAdapter(RollbackToSavepointEvent.class)
public class RollbackToSavepointEventAdapter extends LogMinerEventAdapter {

    /**
     * A ProtoStream factory that creates {@link RollbackToSavepointEvent} instances.
     *
     ...
     * @return the constructed RollbackToSavepointEvent
     */
    @ProtoFactory
