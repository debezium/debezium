...
public class RedoSqlDmlEventAdapter extends DmlEventAdapter {
    ...
    public RedoSqlDmlEvent factory(int eventType, String scn, String tableId, String rowId, String rsId, String changeTime,
        ...
        return new RedoSqlDmlEvent(EventType.from(eventType), Scn.valueOf(scn), TableId.parse(tableId), rowId, rsId, Instant.parse(changeTime),
                oldValues, newValues, redoSql);
    }
