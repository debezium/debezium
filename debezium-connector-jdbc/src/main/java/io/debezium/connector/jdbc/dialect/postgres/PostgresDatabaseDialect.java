...
public class PostgresDatabaseDialect extends GeneralDatabaseDialect {
    ...
    protected String getOverrideClause(TableDescriptor table) {
        // A GENERATED ALWAYS column rejects the explicit primary key value the sink has to supply. The
        // clause is inert on any other column, so ALWAYS and BY DEFAULT need not be told apart.
        return table.hasAutoGeneratedIdentityColumn() ? " OVERRIDING SYSTEM VALUE" : "";
    }
