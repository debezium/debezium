...
/**
 * An implementation of {@link AbstractFloatVectorType} for SingleStore's {@code vector} data type.
 */
class FloatVectorType extends AbstractFloatVectorType {
    ...
    public String getTypeName(Schema schema, boolean isKey) {
        ...
        return size.map(s -> String.format("vector(%s, F32)", s)).orElse("vector(2048, F32)");
    }
