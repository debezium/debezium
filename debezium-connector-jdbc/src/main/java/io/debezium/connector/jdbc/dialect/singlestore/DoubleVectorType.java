...
/**
 * An implementation of {@link AbstractDoubleVectorType} for SingleStore's {@code vector} data type.
 */
class DoubleVectorType extends AbstractDoubleVectorType {
    ...
    public String getTypeName(Schema schema, boolean isKey) {
        ...
        return size.map(s -> String.format("vector(%s, F64)", s)).orElse("vector(16383, F64)");
    }
