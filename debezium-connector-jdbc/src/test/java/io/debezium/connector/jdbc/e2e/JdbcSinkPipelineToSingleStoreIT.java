...
/**
 * End-to-end pipeline tests that write to SingleStore.
 */
@Tag("all")
@Tag("e2e")
@Tag("e2e-singlestore")
...
public class JdbcSinkPipelineToSingleStoreIT extends AbstractJdbcSinkIT {

    @TestTemplate
    @ForSource(value = SourceType.MYSQL, reason = "Verifies a MySQL source can write to a SingleStore sink")
    public void testMySqlSourceToSingleStoreSink(Source source, Sink sink) throws Exception {
        ...
        sink.assertColumn(destinationTable, "data", "LONGTEXT");
