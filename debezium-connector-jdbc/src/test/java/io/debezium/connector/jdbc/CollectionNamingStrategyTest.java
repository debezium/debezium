...
public class CollectionNamingStrategyTest {
    ...
    public void testDefaultTableNamingStrategy() {
        ...
        assertThat(strategy.resolveCollectionName(new KafkaDebeziumSinkRecord(factory.createRecord("database.schema.table")), config.getCollectionNameFormat()))
    ...
    public void testDefaultTableNamingStrategyWithDebeziumSource() {
        ...
        assertThat(strategy.resolveCollectionName(new KafkaDebeziumSinkRecord(sinkRecord), config.getCollectionNameFormat()))
    ...
    public void testDefaultTableNamingStrategyWithInvalidSourceField() {
        ...
        final DefaultCollectionNamingStrategy strategy = new DefaultCollectionNamingStrategy();
        SinkRecord sinkRecord = factory.createRecord("database.schema.table", (byte) 1, "database1", "schema1", "table1");
        Assertions.assertThrows(DataException.class, () -> strategy.resolveCollectionName(new KafkaDebeziumSinkRecord(sinkRecord), config.getCollectionNameFormat()));
    }
    ...
    public void testDefaultTableNamingStrategyWithDebeziumSourceAndTombstone() {
        ...
        assertThat(strategy.resolveCollectionName(new KafkaDebeziumSinkRecord(sinkRecord), config.getCollectionNameFormat())).isNull();
    }
    ...
    public void testDefaultTableNamingStrategyWithTopicAndTombstone() {
        ...
        final DefaultCollectionNamingStrategy strategy = new DefaultCollectionNamingStrategy();
        SinkRecord sinkRecord = factory.tombstoneRecord("database.schema.table");
        assertThat(strategy.resolveCollectionName(new KafkaDebeziumSinkRecord(sinkRecord), config.getCollectionNameFormat())).isEqualTo("kafka_database_schema_table");
    }
}
