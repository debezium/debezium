...
public abstract class AbstractCachedTableMappingStorage<V> implements TableMappingStorage<V> {
     ...
     * Called during {@link #configure(RelationalDatabaseConnectorConfig, boolean, TableMappingStorage.Type)}.
     *
     * @param config the connector configuration
     * @param type the type of storage (schemas or tables)
     */
    protected abstract void configureStorage(RelationalDatabaseConnectorConfig config, TableMappingStorage.Type type);
