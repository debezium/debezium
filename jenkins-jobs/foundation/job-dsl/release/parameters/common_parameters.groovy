return { parametersContext ->
    parametersContext.with {
        stringParam(
                'SOURCE_REPOSITORIES',
                'debezium#github.com/debezium/debezium.git cassandra#github.com/debezium/debezium-connector-cassandra.git cockroachdb#github.com/debezium/debezium-connector-cockroachdb.git db2#github.com/debezium/debezium-connector-db2.git ibmi#github.com/debezium/debezium-connector-ibmi.git informix#github.com/debezium/debezium-connector-informix.git ingres#github.com/debezium/debezium-connector-ingres.git spanner#github.com/debezium/debezium-connector-spanner.git vitess#github.com/debezium/debezium-connector-vitess.git tidb#github.com/debezium/debezium-connector-tidb.git yashandb#github.com/debezium/debezium-connector-yashandb.git milvus#github.com/debezium/debezium-connector-milvus.git#main quarkus#github.com/debezium/debezium-quarkus.git server#github.com/debezium/debezium-server.git operator#github.com/debezium/debezium-operator.git platform#github.com/debezium/debezium-platform.git#debezium-platform-conductor#main',
