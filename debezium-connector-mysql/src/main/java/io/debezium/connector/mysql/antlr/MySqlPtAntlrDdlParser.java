...
import io.debezium.ddl.parser.mysql.legacy.MySqlParser.CharsetNameContext;
import io.debezium.ddl.parser.mysql.legacy.MySqlParser.CollationNameContext;
import io.debezium.ddl.parser.mysql.legacy.MySqlParser.RenameTableClauseContext;
import io.debezium.ddl.parser.mysql.legacy.MySqlParser.RenameTableContext;
...
/**
 * An ANTLR based parser for MySQL DDL statements using Positive Technologies grammar.
 *
 * @author Roman Kuchár <kucharrom@gmail.com>.
 */
public class MySqlPtAntlrDdlParser extends AntlrDdlParser<MySqlLexer, MySqlParser> {
    ...
    @VisibleForTesting
    public MySqlPtAntlrDdlParser(TableFilter tableFilter) {
     ...
     * {@link MySqlPtAntlrDdlParser#currentSchema()} will be used if definition of schema name is not part of the context.
     *
