 ...
 */
public class ReadToInsertEvent<R extends ConnectRecord<R>> implements Transformation<R>, Versioned, ConfigDescriptor {
    ...
    public Field.Set getConfigFields() {
        return Field.setOf(); // No configuration fields
    }
}
