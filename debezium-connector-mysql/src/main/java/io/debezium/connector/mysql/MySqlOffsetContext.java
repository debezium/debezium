...
public class MySqlOffsetContext implements OffsetContext {
    ...
    public MySqlOffsetContext(boolean snapshot, boolean snapshotCompleted, SourceInfo sourceInfo) {
        this(snapshot, snapshotCompleted, new TransactionContext(), new IncrementalSnapshotContext<>(),
                sourceInfo);
    }
    ...
    public static MySqlOffsetContext initial(MySqlConnectorConfig config) {
        final MySqlOffsetContext offset = new MySqlOffsetContext(false, false, new SourceInfo(config));
