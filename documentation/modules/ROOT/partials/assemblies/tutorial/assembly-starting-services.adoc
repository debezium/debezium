...
In this tutorial,
you will set up a single instance of each service using http://docker.com[Docker] and https://hub.docker.com/u/debezium/[the {prodname} container images].
...
include::{partialsdir}/modules/tutorial/proc-starting-zookeeper.adoc[leveloffset=+1]
