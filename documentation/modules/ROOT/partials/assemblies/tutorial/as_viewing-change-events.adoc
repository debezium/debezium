...
include::{partialsdir}/modules/tutorial/p_viewing-create-event.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/p_updating-database-viewing-update-event.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/p_deleting-record-database-viewing-delete-event.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/p_restarting-kafka-connect-service.adoc[leveloffset=+1]
