...
include::{partialsdir}/modules/tutorial/kafka-connect/proc-registering-connector-monitor-inventory-database.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/kafka-connect/ref-watching-connector-start-up.adoc[leveloffset=+1]
