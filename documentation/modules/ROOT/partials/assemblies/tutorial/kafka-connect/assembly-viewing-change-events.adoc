...
include::{partialsdir}/modules/tutorial/kafka-connect/proc-viewing-create-event.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/kafka-connect/proc-updating-database-viewing-update-event.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/kafka-connect/proc-deleting-record-database-viewing-delete-event.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/kafka-connect/proc-restarting-kafka-connect-service.adoc[leveloffset=+1]
