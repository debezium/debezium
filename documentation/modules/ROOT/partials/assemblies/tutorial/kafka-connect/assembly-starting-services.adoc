...
include::{partialsdir}/modules/tutorial/kafka-connect/con-considerations-running-debezium-with-docker.adoc[leveloffset=+1]

include::{partialsdir}/modules/tutorial/kafka-connect/proc-starting-kafka.adoc[leveloffset=+1]
...
include::{partialsdir}/modules/tutorial/kafka-connect/proc-starting-kafka-connect.adoc[leveloffset=+1]
