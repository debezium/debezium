...
The following list describes select fields in the preceding incremental snapshot event message example:

`"snapshot":"incremental"`::
Specifies the type of snapshot operation.
