...
tag::set-binlog-position-procedure[]
...
INSERT INTO debezium_signal (id, type, data) VALUES (
  'set-position-001',
  'set-binlog-position',
  '{"binlog_filename": "{binlog-filename-example}", "binlog_position": 1234}'
);
----
+
SQL to use when GTID is enabled (specifies {gtid-label})::
+
[source,sql,indent=0,subs="+attributes"]
----
INSERT INTO debezium_signal (id, type, data) VALUES (
...
end::set-binlog-position-procedure[]
