...
end::set-binlog-position-intro[]


==== Format of a `set-binlog-position` signal

tag::set-binlog-position-format[]
...
end::set-binlog-position-format[]


==== Send a signal to reposition the stream

tag::set-binlog-position-procedure-mysql[]
Send a {prodname} `set-binlog-position` signal at run time to specify the binlog reading position for the MySQL connector.
...
end::set-binlog-position-procedure-mysql[]

tag::set-binlog-position-procedure-mariadb[]
Send a {prodname} `set-binlog-position` signal at run time to specify the binlog reading position for the MariaDB connector.
...
----
3. Restart the connector to begin streaming from the new position.
end::set-binlog-position-procedure-mariadb[]
