...
|3
a|Obtain a global read lock on the tables to be captured to block _writes_ by other database clients.
...
|`recovery`
a|Set this option to restore a database schema history topic that is lost or corrupted.
