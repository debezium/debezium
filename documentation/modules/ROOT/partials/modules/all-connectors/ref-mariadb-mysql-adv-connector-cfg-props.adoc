...
[id="{context}-property-guardrail-tables-max"]
xref:{context}-property-guardrail-tables-max[`guardrail.tables.max`]::
...
[id="{context}-property-guardrail-tables-limit-action"]
xref:{context}-property-guardrail-tables-limit-action[`guardrail.tables.limit.action`]::
...
`fail`:::: The connector fails if the total number of tables being captured exceed the maximum limit specified by the `guardrail.tables.max` property.

`warn`:::: The connector logs a warning if the total number of tables being captured exceed the maximum limit specified by the `guardrail.tables.max` property.
