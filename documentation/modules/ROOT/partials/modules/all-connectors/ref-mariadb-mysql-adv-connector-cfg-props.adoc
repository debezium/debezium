...
`positive_technology`:::: Uses the legacy Positive Technologies (PT) MySQL grammar.
...
+
In most cases, you should use the default `oracle` grammar.
Use the `positive_technology` grammar only if you encounter compatibility issues with existing DDL statements during migration.
