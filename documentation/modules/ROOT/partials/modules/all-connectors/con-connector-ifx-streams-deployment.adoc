You deploy the {prodname} Informix connector on OpenShift by using {StreamsName} to build a Kafka Connect container image that includes the connector plug-in.
