...
|`long`
|The minimum lag in milliseconds behind the source that has been observed during the connector's runtime.
...
|`long`
|The maximum lag in milliseconds behind the source that has been observed during the connector's runtime.
...
This metric provides a more robust measure of typical lag than the average, as it is less affected by outliers.
