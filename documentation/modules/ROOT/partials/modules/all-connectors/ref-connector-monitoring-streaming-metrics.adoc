...
|`long`
|The total number of create events that this connector has seen since last started or reset.
...
|`long`
|The total number of update events that this connector has seen since last started or reset.
...
|`long`
|The total number of delete events that this connector has seen since last started or reset.
