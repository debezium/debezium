...
== {link-prefix}:{link-mysql-connector-advanced-properties}#advanced-mysql-connector-properties[Advanced MySQL connector properties]
...
== {link-prefix}:{link-mysql-connector-pass-through-properties}#mysql-connector-pass-through-properties[Pass-through configuration properties]
