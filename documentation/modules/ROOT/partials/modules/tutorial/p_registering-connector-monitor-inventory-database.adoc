...
For more information about connector configuration properties, see {link-prefix}:{link-deploy-mysql-connector}#mysql-connector-configuration-properties_{context}[MySQL connector configuration properties].
--
