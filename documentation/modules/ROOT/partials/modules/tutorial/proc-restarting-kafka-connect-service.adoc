...
When the Kafka Connect service goes offline and restarts, {prodname} resumes capturing database changes from the point where it stopped, without missing any events.
