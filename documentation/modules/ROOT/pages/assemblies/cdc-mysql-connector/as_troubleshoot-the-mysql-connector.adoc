...
:context: troubleshootMysql
[id="troubleshoot-the-mysql-connector"]
= Troubleshooting the MySQL connector
...
* xref:kakfa-connect-stops_{context}[Kakfa Connect stops]
...
include::../../modules/cdc-mysql-connector/r_kakfa-connect-stops.adoc[leveloffset=+1]
