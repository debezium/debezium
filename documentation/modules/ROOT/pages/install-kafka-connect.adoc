[id="installing-kafka-connect"]
= Installing {prodname} Kafka Connect Connectors
...
xref:connectors/cockroachdb.adoc#cockroachdb-deploying-a-connector[CockroachDB Connector],
xref:connectors/yashandb.adoc#deploying-yashandb-connector[YashanDB Connector],
xref:connectors/ingres.adoc#ingres-deploying-a-connector[Ingres Connector],
xref:connectors/milvus.adoc#milvus-deployment[Milvus Connector],
