...
Understanding how loggers, log levels, and appenders work together helps you set a logging configuration that filters log output to ensure visibility of relevant information.

Loggers::
The application sends each log message to a specific logger, for example, `io.debezium.connector.mysql`.
...
You can override the default configuration of individual child or descendant loggers.
