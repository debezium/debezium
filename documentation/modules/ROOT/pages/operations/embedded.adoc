...
[IMPORTANT]
====
This page describes an internal API that is subject to changes and might be removed without a further notice.
Please use the new supported xref:development/engine.adoc[Debezium Engine API].
====
