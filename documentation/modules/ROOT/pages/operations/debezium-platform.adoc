...
The Stage UI intelligently recognizes the configuration type and prompts you prompts you to reformat it for use by the platform.
...
Select this option to automatically extract the sink configuration and convert the sink properties into the JSON format the {prodname} Platform supports.
