...
|
|If given, enable JWT authentication with NATS. You must provide an NKey seed to use this authentication technique.

|[[nats-jetstream-auth-seed]]<<nats-jetstream-auth-seed, `debezium.sink.nats-jetstream.auth.seed`>>
|
|The NKey seed to use with the JWT.

|[[nats-jetstream-auth-user]]<<nats-jetstream-auth-user, `debezium.sink.nats-jetstream.auth.user`>>
|
|If given, enable user/password authentication with NATS. You must provide a password to use this authentication technique.
Cannot be used with JWT authentication.

|[[nats-jetstream-auth-password]]<<nats-jetstream-auth-password, `debezium.sink.nats-jetstream.auth.password`>>
|
|The password to use for user/password authentication.
