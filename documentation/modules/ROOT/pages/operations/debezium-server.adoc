...
In environments that do not have persistent gRPC connections, set the following properties to specify how {prodname} Server uses the REST route to deliver event records to a target table.
