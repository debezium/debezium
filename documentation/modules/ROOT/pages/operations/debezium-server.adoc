...
|[[redis-trim-relative-minid]]<<redis-trim-relative-minid, `debezium.sink.redis.trim.relative.minid`>>
|
|(Optional) Specify the milliseconds, relative to the current time,
