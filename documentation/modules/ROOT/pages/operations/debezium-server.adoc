...
Currently the sink implements the `typed` mode only, and it reports an error at start-up if you set any other value.
...
Currently the sink implements the `json` format only, and it reports an error at start-up if you set any other value.
