...
|[[redis-retry-initial-time-ms]]<<redis-retry-initial-time-ms, `debezium.sink.redis.retry.initial.time.ms`>>
|`300`
|Initial retry time when encountering Redis connection or OOM issues.
This value will be doubled upon every retry but won't exceed `debezium.sink.redis.retry.max.time.ms`

|[[redis-retry-max-time-ms]]<<redis-retry-max-time-ms, `debezium.sink.redis.retry.max.time.ms`>>
|`10000`
|Max time to wait when encountering Redis connection or OOM issues.
