...
ifeval::['{page-version}' != 'master']
* https://repo1.maven.org/maven2/io/debezium/debezium-server-distro/{debezium-version}/debezium-server-distro-{debezium-version}.tar.gz[{prodname} Server distribution]
endif::[]
