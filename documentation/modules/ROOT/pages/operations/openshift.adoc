...
These instructions have been tested by using the https://github.com/minishift/minishift[Minishift tool], which allows you to run a single node OpenShift instance locally on your machine.
...
To set up Kafka and Kafka Connect on OpenShift, use the set of images that are provided by the https://strimzi.io/[Strimzi] project. These images offer "Kafka as a Service" by providing
enterprise grade configuration files and images that bring Kafka to OpenShift.

. Install the operators and templates for the Kafka broker and Kafka Connect into your OpenShift project:
+
