...
|xref:{link-event-flattening}#extract-new-record-state-drop-fields-header-name[`drop.fields.header.name`]
|
|The Kafka message header name to source fields that should be dropped.

[id="extract-new-record-state-drop-fields-from-key"]
|xref:{link-event-flattening}#extract-new-record-state-drop-fields-from-key[`drop.fields.from.key`]
|`false`
|Controls whether fields are also be dropped fom the event's key.

[id="extract-new-record-state-drop-fields-keep-schema-compatible"]
|xref:{link-event-flattening}#extract-new-record-state-drop-fields-keep-schema-compatible[`drop.fields.keep.schema.compatible`]
|`true`
|Controls whether non-optional fields will be removed if they're included in the xref:{link-event-flattening}#extract-new-record-state-drop-fields-header-name[`drop.fields.header.name`] configuration property. +
 +
The default behavior is to only remove fields if they're marked optional.
