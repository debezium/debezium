...
// Type: procedure
// ModuleID: debezium-swap-geometry-coordinates-enable-SMT-to-convert-coordinate-system
// Title: Enable the swap geometry coordinates SMT to convert the coordinate system of captured data
