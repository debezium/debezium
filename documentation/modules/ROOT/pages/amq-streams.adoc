...
Next we are going to verify whether the deployment is correct by emulating the xref:tutorial.adoc[Debezium Tutorial] and following the steps in xref:openshift.adoc#verifying_the_deployment[OpenShift Installation]
