...
include::modules/tutorial/c_introduction-debezium.adoc[leveloffset=+1]

include::assemblies/tutorial/as_starting-services.adoc[leveloffset=+1]

include::assemblies/tutorial/as_deploying-mysql-connector.adoc[leveloffset=+1]

include::assemblies/tutorial/as_viewing-change-events.adoc[leveloffset=+1]

include::modules/tutorial/p_cleaning-up.adoc[leveloffset=+1]

include::modules/tutorial/c_next-steps.adoc[leveloffset=+1]
