...
This example speaks specifically about `SourceRecord` but the engine implementation is parametrized and in future different types like `JSON` or `Avro` could be returned by the engine.
