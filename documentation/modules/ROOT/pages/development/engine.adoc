...
----
 /**
   ...
   */
  void handleBatch(List<R> records, RecordCommitter committer) throws InterruptedException;
----
...
class MyChangeConsumer implements EmbeddedEngine.ChangeConsumer<RecordChangeEvent<SourceRecord>> {
  public void handleBatch(List<SourceRecord> records, RecordCommitter committer) throws InterruptedException {
    ...
  }
}
// Create the engine with this configuration ...
DebeziumEngine<RecordChangeEvent<SourceRecord>> engine = DebeziumEngine.create(Connect.class)
        .using(props)
