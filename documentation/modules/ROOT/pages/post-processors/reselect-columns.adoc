...
[NOTE]
====
You can use the `ReselectColumnsPostProcessor` post processor only with {prodname} source connectors.
...
----
  ...
  "post.processors.reselector.type" : "io.debezium.processors.reselect.ReselectColumnsPostProcessor", // <2>
  "post.processors.reselector.reselect.columns.include.list" : "_<schema>_.__<table>__:__<column>__,__<schema>__.__<table>__:__<column>__", // <3>
  "post.processors.reselector.reselect.unavailable.values" : "true", // <4>
  "post.processors.reselector.reselect.null.values" : "true", // <5>
  "post.processors.reselector.reselect.use.event.key" : "false", // <6>
  "post.processors.reselector.reselect.error.handling.mode" : "WARN" // <7>
----
