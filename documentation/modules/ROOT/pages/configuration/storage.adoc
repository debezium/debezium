...
|xref:jdbc-offset-table-ddl-default[`jdbc.offset.table.ddl.default` (1. Table Structure)]
...
|xref:jdbc-offset-table-ddl-default[`jdbc.offset.table.select.default` (2. Select query)] 
...
|xref:jdbc-offset-table-insert-default[`jdbc.offset.table.insert.default` (3. Insert query]
...
|xref:jdbc-offset-table-delete-default[`jdbc.offset.table.delete.default` (4. Delete query)]
...
|xref:jdbc-offset-table-select-default[`jdbc.offset.table.select.default` (2. Select query)]
...
[[jdbc-offset-table-ddl-default]]<<jdbc-offset-table-ddl-default, `jdbc.offset.table.ddl.default` (1. Table Structure)>>
[SQL]
----
CREATE TABLE %s (
...
[[jdbc-offset-table-select-default]]<<jdbc-offset-table-select-default, `jdbc.offset.table.select.default` (2. Select query)>>
[SQL]
----
SELECT id, offset_key, offset_val FROM %s ORDER BY record_insert_ts, record_insert_seq
----

[[jdbc-offset-table-insert-default]]<<jdbc-offset-table-insert-default, `jdbc.offset.table.insert.default` (3. Insert query)>>
[SQL]
----
...
[[jdbc-offset-table-delete-default]]<<jdbc-offset-table-delete-default, `jdbc.offset.table.delete.default` (4. Delete query)>>
[SQL]
----
DELETE FROM %s
----
