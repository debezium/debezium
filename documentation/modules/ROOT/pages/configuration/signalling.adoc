...
|(Required) An arbitrary unique string that identifies a signal instance.
...
|(Required) Specifies the type of signal to send.
...
|(Optional) Specifies JSON-formatted parameters to pass to a signal action.
