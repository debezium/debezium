...
The MongoDB connector captures the changes in a replica set or sharded cluster.
...
+
he following example shows a typical message:
...
+
ollowing is an example of what a message looks like:
