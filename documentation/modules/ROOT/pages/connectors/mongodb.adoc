...
However, if this position was removed from the oplog, the connector might fail to start, depending on the value specified for the connector's `snapshot.mode` property.
