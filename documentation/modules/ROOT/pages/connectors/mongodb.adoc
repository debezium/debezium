...
[WARNING]
====
If you set the value of this property to `database`,  to use {prodname} signaling , the signaling collection must reside in the database that is  specified by the xref:mongodb-property-capture-target[`capture.target`] property.
====
