...
This is the recommended mode starting with MongoDB 4.x and cannot be used with MongoDB 3.x.
...
include::{partialsdir}/modules/all-connectors/proc-triggering-an-incremental-snapshot.adoc[leveloffset=+3]
