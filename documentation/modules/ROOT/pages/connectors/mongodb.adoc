...
If an offset can be found and it still exists in the oplog, then the task immediately proceeds with link:#streaming-changes[streaming changes], starting at the recorded offset position.
