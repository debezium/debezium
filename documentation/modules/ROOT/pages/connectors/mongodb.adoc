...
`sharded`:: The connector establishes a single connection to Mongo router, based on the value of the xref:mongodb-property-mongodb-connection-string[`mongodb.connection.string`].
