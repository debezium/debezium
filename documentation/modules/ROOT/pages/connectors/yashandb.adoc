...
[[yashandb-legacy-version-support]]
== Legacy version support

The YashanDB connector for {prodname} 2.4.2 and earlier versions is maintained by the YashanDB organization and is not an officially supported version within the {prodname} community.
This legacy version is provided for users who still rely on older {prodname} releases.

[IMPORTANT]
====
Users of the legacy YashanDB connector are encouraged to upgrade to the latest {prodname} community release as soon as possible to benefit from official support, bug fixes, and new features.
====

For more information about the legacy YashanDB connector, see the link:https://github.com/yashan-technologies/debezium-connector-yashandb/tree/2.4.2[YashanDB connector legacy repository^].
