...
|[[db2-property-table-whitelist]]<<db2-property-table-whitelist [[db2-property-table-include-list]]<<db2-property-table-include-list, `table.include.list`>>
|
...
|[[db2-property-table-blacklist]]<<db2-property-table-blacklist [[db2-property-table-exclude-list]]<<db2-property-table-exclude-list, `table.exclude.list`>>
|
...
|[[db2-property-column-blacklist]]<<db2-property-column-blacklist [[db2-property-column-exclude-list]]<<db2-property-column-exclude-list, `column.exclude.list`>>
|_empty string_
