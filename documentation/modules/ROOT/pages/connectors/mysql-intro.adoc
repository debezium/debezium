...
* xref::../assemblies/overview-of-how-the-mysql-connector-works.adoc[Overview of how the MySQL connector works]
* xref::../assemblies/setup-the-mysql-server.adoc[Setting up MySQL server]
* xref::../assemblies/deploy-the-mysql-connector.adoc[Deploying the MySQL connector]
* xref::../assemblies/troubleshoot-the-mysql-connector.adoc[Troubleshooting the MySQL connector]
