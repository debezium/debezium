...
|[[sqlserver-property-guardrail-tables-max]]<<sqlserver-property-guardrail-tables-max, `+guardrail.tables.max+`>>
|`0`
...
|[[sqlserver-property-guardrail-tables-limit-action]]<<sqlserver-property-guardrail-tables-limit-action, `+guardrail.tables.limit.action+`>>
|`warn`
