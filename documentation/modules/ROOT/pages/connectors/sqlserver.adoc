...
Setting the property to a value that is greater than the number of nodes permits the connector distribute work by creating separate tasks to read from each node.
