...
For more information on the performance impact of sys.sp_cdc_enable_table's parameters, see this https://docs.microsoft.com/en-us/previous-versions/sql/sql-server-2008/dd266396(v=sql.100)[whitepaper] conducted by Microsoft.
