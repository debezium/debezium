...
=====================================================================
+
The following list describes the purpose of select lines in the preceding Dockerfile example:

`debezium-container-for-{context}.yaml`::
You can specify any file name that you want.

`/opt/kafka/plugins/debezium`::
...
Indicates to the Cluster Operator that `KafkaConnector` resources are used to configure connectors in this Kafka Connect cluster.
