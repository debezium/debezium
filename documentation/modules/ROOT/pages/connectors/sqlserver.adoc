...
spec:
  ...
  config:
    ...
    driver.trustStore: path/to/trust-store // <11>
    driver.trustStorePassword: password-for-trust-store <12>
----
+
...
----
{
    ...
    "config": {
        ...
        "driver.trustStore": "path/to/trust-store", // <12>
        "driver.trustStorePassword": "password-for-trust-store" // <13>
    }
}
----
