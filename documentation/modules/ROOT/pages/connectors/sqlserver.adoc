...
The message contains a logical representation of the table schema and (for some of the connectors) SQL commands that created the schema change.
...
* `type` is the tpy of the change: `CREATE` - table created, `ALTER` - table modified, `DROP` - table deleted
