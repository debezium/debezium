...
The {prodname} PostgreSQL connector also provides the following custom streaming metric:

[cols="3,2,5",options="header"]
|===
|Attribute |Type |Description

|[[postgres-streaming-metrics-total-number-of-logical-message-events-seen]]<<postgres-streaming-metrics-total-number-of-logical-message-events-seen, `+TotalNumberOfLogicalMessageEventsSeen+`>>
|`long`
|The total number of logical decoding message events processed by the connector since its last start or metrics reset.
