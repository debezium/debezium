...
If you configure {prodname} to create replication slots automatically, the value of `proto_version` is hardcoded to `1`.
...
To take advantage of those features, create slots manually and set the `proto_version` to a higher value.
