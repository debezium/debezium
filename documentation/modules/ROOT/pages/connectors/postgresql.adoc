...
See the following procedure for guidance about how to perform a PostgreSQL database upgrade to enable {prodname} to continue to capture events, and minimize the risk of data loss.
