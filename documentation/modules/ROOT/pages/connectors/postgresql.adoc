...
|[[postgresql-property-guardrail-tables-max]]<<postgresql-property-guardrail-tables-max, `+guardrail.tables.max+`>>
|`0`
...
|[[postgresql-property-guardrail-tables-limit-action]]<<postgresql-property-guardrail-tables-limit-action, `+guardrail.tables.limit.action+`>>
|`warn`
