...
+
ollowing is an example of a message:
...
+
OTE: In the preceding example, the underscore character (`_`) represents an escape sequence, equivalent to a backslash in Java.
