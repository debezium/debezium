...
|`none-validated`
|The connector does not perform any DDL schema evolution, but validates statically resolvable destination tables during startup.
...
`none-validated`:: Specifies that the connector does not evolve the destination schema, but validates statically resolvable destination tables during startup.
