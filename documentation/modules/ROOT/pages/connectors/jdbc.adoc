...
For more information on the performance benefits, see link:https://www.tigerdata.com/blog/boosting-postgres-insert-performance[Boosting Postgres Insert Performance].
