...
|source
| List of channels names that are enabled. Available channel: `source`, `kafka`. See how to {link-prefix}:{link-signalling}#debezium-signaling-enabling-custom-signaling-channel[Provide custom signaling channel]

|[[mysql-property-notification-enabled-channels]]<<mysql-property-notification-enabled-channels, `+notification.enabled.channels+`>>
|No default
| List of channels names that are enabled. Available channel: `sink`, `log`. See how to {link-prefix}:{link-notification}#debezium-notification-custom-channel[Provide custom notification channel]
