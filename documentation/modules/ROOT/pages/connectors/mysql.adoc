...
. If you are running MySQL on Amazon RDS, make sure to enable automated backups for your database instance. Otherwise, the binlog will not be enabled, despite of the settings described above.
