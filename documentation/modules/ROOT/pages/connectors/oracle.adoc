...
Consequently, the {prodname} connector for Oracle will consistently display empty `row_id` values in the source information block when utilizing the OpenLogReplicator adapter.
