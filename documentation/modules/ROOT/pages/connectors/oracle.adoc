...
||[[oracle-property-database-schema]]<<oracle-property-database-schema, `database.schema`>>
|
|Name of the schema that the connector intends to monitor.
This field is required only when using the `logminer` adapter.
