...
|[[oracle-property-incremental-snapshot-pool-release-delay-ms]]<<oracle-property-incremental-snapshot-pool-release-delay-ms, `+incremental.snapshot.pool.release.delay.ms+`>>
|`60000` (1 minute)
...
|[[oracle-property-incremental-snapshot-retry-max-attempts]]<<oracle-property-incremental-snapshot-retry-max-attempts, `+incremental.snapshot.retry.max.attempts+`>>
|`5`
...
|[[oracle-property-incremental-snapshot-retry-initial-delay-ms]]<<oracle-property-incremental-snapshot-retry-initial-delay-ms, `+incremental.snapshot.retry.initial.delay.ms+`>>
|`1000`
...
|[[oracle-property-incremental-snapshot-retry-max-delay-ms]]<<oracle-property-incremental-snapshot-retry-max-delay-ms, `+incremental.snapshot.retry.max.delay.ms+`>>
|`60000` (1 minute)
...
|[[oracle-property-incremental-snapshot-retry-backoff-multiplier]]<<oracle-property-incremental-snapshot-retry-backoff-multiplier, `+incremental.snapshot.retry.backoff.multiplier+`>>
|`2.0`
...
|[[oracle-streaming-metrics-total-abandoned-transaction-count]]<<oracle-streaming-metrics-total-abandoned-transaction-count, `+TotalAbandonedTransactionCount+`>>
|`long`
|The total number of transactions abandoned from the transaction buffer since the connector started.
Unlike xref:oracle-streaming-metrics-abandoned-transaction-count[`AbandonedTransactionCount`], this value is not capped by the size of the abandoned transactions list and increments every time a transaction is abandoned.
