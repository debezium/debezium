...
2. Ensure that network and file access settings permit the downstream mining database to access the dictionary file and redo logs on the primary database.
3. Monitor the dictionary file synchronization to prevent issues with schema change detection.
endif::community[]
