...
Only after a physical standby is converted to the primary database, can the connector access it to capture events, just as it would from any other primary database.
