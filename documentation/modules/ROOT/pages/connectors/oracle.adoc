...
|[[oracle-property-database-secondary-hostname]]<<oracle-property-database-secondary-hostname, `+secondary.hostname+`>>
|No default
...
|[[oracle-property-database-secondary-port]]<<oracle-property-database-secondary-port, `+secondary.port+`>>
...
|[[oracle-property-database-secondary-url]]<<oracle-property-database-secondary-url, `+secondary.url+`>>
|No default
