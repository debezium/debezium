...
As an alternative to LogMiner, the {prodname} Oracle connector can use OpenLogReplicator, a free, open-source, third-party application to read changes directly from the Oracle redo and archive logs with low database impact.
