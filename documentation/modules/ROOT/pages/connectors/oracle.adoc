...
[IMPORTANT]
====
Oracle Autonomous Database does not provide access to online redo logs.
You must explicitly set `log.mining.archive.log.only.mode=true` in the connector configuration.
