...
If the table has no primary key, or the row was deleted before the connector could re-select it, the connector logs a warning and cannot provide the complete LOB value for the event.
