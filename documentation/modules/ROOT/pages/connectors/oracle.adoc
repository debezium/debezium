...
`dictionary_from_file`:: Uses dictionary from file located in a Oracle directory object. Use this option if you set the log.mining.read.only to true and informed a log.mining.readonly.hostname.
