...
As {prodname} cannot safely provide the column value when its not provided by the database, the connector returns a placeholder as defined by the connector configuration property, `unavailable.value.placeholder`.
====
