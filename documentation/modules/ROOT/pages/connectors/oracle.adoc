...
* xref:using-debezium-oracle-connector-with-autonomous-database[]
...
// Type: concept
// Title: Using {prodname} Oracle connector with Oracle Autonomous Database
...
* Do not specify the `database.pdb.name` property. ADB provides a fully managed PDB environment, and the connector operates within that context automatically.
