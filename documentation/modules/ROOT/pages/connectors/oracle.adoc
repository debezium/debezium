...
You can set properties to apply only to specific cache instances,for example, specifying the number of entries permitted in memory, or the overall size of the persistence store.
