...
If you use a logical standby, to guarantee that no change events are lost, after the database is open, configure a new connector and perform a new database snapshot.
