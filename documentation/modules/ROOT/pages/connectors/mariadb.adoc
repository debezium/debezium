...
// Type: concept
[id="debezium-mariadb-chunk-based-parallel-snapshots"]
...
// Type: assembly
// ModuleID: debezium-mariadb-connector-send-a-signal-to-reset-the-binlog-reading-position
...
// Type: concept
// ModuleID: debezium-mariadb-connector-format-of-a-set-binlog-position-signal
...
// Type: procedure
// ModuleID: debezium-mariadb-connector-send-a-signal-to-change-the-binlog-reading-position
// Title: Send a signal to change the binlog reading position
==== Send a signal to reposition the stream

:binlog-filename-example: mariadb-bin.000003
:gtid-label: domain-server-sequence GTID set
:gtid-value: 0-1-100
