...
|No default
|If the topic naming strategy `io.debezium.connector.vitess.TableTopicNamingStrategy` is used, this property is used in place of `topic.prefix` to create the data change topic name.
