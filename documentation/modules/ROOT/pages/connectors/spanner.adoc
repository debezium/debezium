...
|[[connectors-strm-metric-millisecondslowwatermark]]<<connectors-strm-metric-lowwatermark, `+MilliSecondsLowWatermarkLag+`>>
|`long`
...
|[[spanner-property-credentials]]<<spanner-property-credentials, `+gcp.spanner.credentials.json+`>>
|No default
