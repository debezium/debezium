...
|[[spanner-property-project]]<<spanner-property-instance, `+gcp.spanner.instance.id+`>>
|No default
...
|[[spanner-property-database]]<<spanner-property-changestream, `+gcp.spanner.change.stream+`>>
|No default
