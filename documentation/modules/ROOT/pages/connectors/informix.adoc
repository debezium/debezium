...
* xref:debezium-informix-ad-hoc-snapshots[]
* xref:debezium-informix-incremental-snapshots[]
* xref:debezium-informix-blocking-snapshots[]
...
==== Triggering an Informix connector incremental snapshot
...
==== Using the Kafka signaling channel to trigger an Informix connector incremental snapshot
...
// Type: concept
[id="debezium-informix-blocking-snapshots"]
=== Blocking snapshots
...
// Type: reference
// ModuleID: monitoring-debezium-informix-connector-schema-history-changes
// Title: Monitoring {prodname} Informix connector schema history
