...
The following example shows how to write the properties file:
[source,properties,indent=0]
----
...
[NOTE]
====
The cipherSuites filed is not mandatory, it simply allows you to add one (or more) ciphers that are not present.
====
