...
The following represents an example .properties configuration file for running and testing Cassandra Connector locally:
...
The connect supports the following kafka connect converters for key/value serialization:
